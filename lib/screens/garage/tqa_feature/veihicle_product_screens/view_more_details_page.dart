...
class ViewMoreDetailsPage extends StatefulWidget {
  ...
  const ViewMoreDetailsPage({Key? key, required this.userProductId}) : super(key: key);

  @override
  State<ViewMoreDetailsPage> createState() => _ViewMoreDetailsPageState();
}

class _ViewMoreDetailsPageState extends State<ViewMoreDetailsPage> {
